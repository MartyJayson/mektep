...
class rm010_create_table_course_lecture
{
	public function up()
	{
		...
		$SQL = "CREATE TABLE IF NOT EXISTS `course_lecture` (
				    ...
				    CONSTRAINT `fk_cource_cl` FOREIGN KEY (`course_fk`) REFERENCES `db`.`courses`(`id`) ON DELETE CASCADE,
				    CONSTRAINT `fk_lecture_cl` FOREIGN KEY (`lecture_fk`) REFERENCES `db`.`lectures`(`user_fk`) ON DELETE CASCADE,
