...
class rm019_create_table_user_permissions
{
	public function up()
	{
		...
		$SQL = "CREATE TABLE IF NOT EXISTS `user_permissions` (
				    ...
				    CONSTRAINT `fk_user_up` FOREIGN KEY (`user_fk`) REFERENCES `db`.`users`(`id`) ON DELETE CASCADE,
				    CONSTRAINT `fk_permission_up` FOREIGN KEY (`permission_fk`) REFERENCES `db`.`permissions`(`id`) ON DELETE CASCADE,
